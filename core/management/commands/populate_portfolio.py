...
from core.models import Skill, Project, ProjectCategory, PortfolioSettings
...
class Command(BaseCommand):
    ...
    def populate_skills(self, force=False):
        skills_data = [
            ...
            {
                "name": "NGINX",
                "icon_url": "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nginx/nginx-original.svg",
                "category": "tool",
                "proficiency_level": 2,
                "display_order": 9
            },
        ...
        projects_data = [
            {
                ...
                "detailed_description": "Sistema completo de gestión de biblioteca digital con autenticación de usuarios, sistema de búsqueda avanzado, gestión de préstamos y devoluciones. Desarrollado con Django y Django REST Framework.",
            ...
            },
            {
                ...
                "detailed_description": "Aplicación web para gestión de tareas con funcionalidades de crear, editar, eliminar y marcar como completadas. Incluye categorización y filtros avanzados.",
            ...
            },
            {
                ...
                "detailed_description": "Aplicación minimalista de to-do list con interfaz limpia y funcionalidades básicas de gestión de tareas.",
    ...
    def populate_settings(self, force=False):
        settings_data = {
            ...
            "about_me": "Desarrollador Backend especializado en Python con más de 2 años de experiencia creando aplicaciones web robustas y escalables. Experto en Django y FastAPI para el desarrollo de APIs RESTful, con sólidos conocimientos en bases de datos SQL/PostgreSQL y optimización de queries.\n\nMi enfoque se centra en código limpio y buenas prácticas, aplicando principios SOLID, patrones de diseño y estándares de desarrollo que garantizan mantenibilidad y escalabilidad. Experiencia práctica en Docker para containerización y GitHub para control de versiones y colaboración en equipos.\n\nMe especializo en:\n\n• Optimización de base de datos: Implementación de índices estratégicos, select_related/prefetch_related\n• Validaciones robustas: Constraints a nivel de modelo y base de datos\n• Testing: Desarrollo dirigido por pruebas con tests unitarios e integración\n• Arquitectura de software: Aplicación de principios SOLID y DRY\n\nSiempre en constante aprendizaje, actualmente explorando arquitecturas de microservicios y herramientas de DevOps. Me apasiona resolver problemas complejos del backend, optimizar rendimiento y crear soluciones técnicas innovadoras que impacten positivamente en la experiencia del usuario.\n\nEnfoque actual: Perfeccionando habilidades en optimización de queries, patrones de diseño avanzados y mejores prácticas de testing para crear aplicaciones backend de alta calidad.",
